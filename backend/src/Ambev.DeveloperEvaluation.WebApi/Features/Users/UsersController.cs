...
public class UsersController : BaseController
{
    ...
    /// <summary>
    /// Retrieves all users with pagination and ordering
    /// </summary>
    /// <param name="request">The pagination and ordering parameters</param>
    /// <param name="cancellationToken">Cancellation token</param>
    /// <returns>Paginated list of users</returns>
    [HttpGet]
    [ProducesResponseType(typeof(PaginatedResponse<GetAllUsersItemResult>), StatusCodes.Status200OK)]
    ...
    public async Task<IActionResult> GetAllUsers([FromQuery] GetAllUsersRequest request, CancellationToken cancellationToken)
    {
        ...
        return Ok(new PaginatedResponse<GetAllUsersItemResult>
        {
            Success = true,
